...
// Upstream project -- also this fork's AGPL Section 7(b) attribution target.
...
export default function AboutTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AGPL Section 7(b) attribution. This is a modified fork -- this notice
          must stay, and must stay reasonably prominent. */}
      <p className="text-xs leading-relaxed text-muted-foreground/70">
        Kraken is a modified version of{' '}
        <a
          href={GITHUB_REPO_URL}
          target="_blank"
          rel="noopener noreferrer"
        ...
        , modified by Cole Smith, August 2026. Licensed under AGPL-3.0-or-later.
        Not affiliated with or endorsed by Siteboon AI B.V.
      </p>
