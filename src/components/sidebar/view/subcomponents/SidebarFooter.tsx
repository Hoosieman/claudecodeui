...
// Upstream project. The footer link below is this fork's AGPL Section 7(b)
// attribution notice -- keep it pointing here.
    ...
    <div className="flex-shrink-0" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0)' }}>
      ...
      {!IS_PLATFORM && (
        <div className="hidden px-3 py-2 text-center md:block">
          ...
          >
            Kraken v{currentVersion} – based on CloudCLI UI
          </a>
        </div>
      )}
